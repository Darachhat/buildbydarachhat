...
class CartService
{
        ...
        try {
            if ($this->cachedCartItems === null) {
                if (Auth::check()) {
                    ...
                    // if user is a guest, retrieve from cookies
    ...
    public function getTotalPrice(): float
    {
        ...
        // Assuming $this->>getCartItems() returns an array of cast items
        foreach ($this->getCartItems() as $item) {
    ...
    public function moveCartItemsToDatabase($userId): void
    {
        ...
        Cookie::queue(self::COOKIE_NAME, '', -1); //Delete cookies by setting
    }
}
